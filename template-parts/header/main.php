    ...
    <div class="max-w-screen-xl mx-auto px-4">
        ...
        <div class="grid grid-cols-1 md:grid-cols-3 gap-8">
            ...
            <div class="group relative bg-[#ffffff12] border border-white/5 p-8 rounded-xl transition-colors duration-500 ease-in-out hover:bg-gradient-to-t hover:from-[#443227] hover:to-[#2D2D2D] overflow-hidden h-full flex flex-col">
                <!-- Content -->
                <h3 class="text-xl font-medium text-white mb-2">Compliance-Aware Marketing</h3>
            ...
            <div class="group relative bg-[#ffffff12] border border-white/5 p-8 rounded-xl transition-colors duration-500 ease-in-out hover:bg-gradient-to-t hover:from-[#443227] hover:to-[#2D2D2D] overflow-hidden h-full flex flex-col">
                <!-- Content -->
                <h3 class="text-xl font-medium text-white mb-2">End-to-End Solutions</h3>
            ...
            <div class="group relative bg-[#ffffff12] border border-white/5 p-8 rounded-xl transition-colors duration-500 ease-in-out hover:bg-gradient-to-t hover:from-[#443227] hover:to-[#2D2D2D] overflow-hidden h-full flex flex-col">
                <!-- Content -->
                <h3 class="text-xl font-medium text-white mb-2">Data-Driven Results</h3>
