<section class="py-24">
        <div class="max-w-4xl mx-auto px-4">
            ...
            <div class="bg-[#ffffff12] border border-white/5 rounded-xl p-8 mb-12">
                <div class="grid grid-cols-1 md:grid-cols-2 gap-8 items-center">
                    <!-- Image Column -->
                    <div class="w-full max-w-[550px] h-[320px] mx-auto md:mx-0">
                    ...
                    <div class="flex flex-col justify-center text-gray-200">
                        ...
                        <p class="text-base text-[#D6D6D6] mb-3 relative pl-5">
            ...
            <div class="bg-[#ffffff12] border border-white/5 rounded-xl p-8 md:p-12">
                <div class="grid grid-cols-1 md:grid-cols-2 gap-8 items-center">
                    ...
                    <div class="w-full max-w-[550px] h-[320px] mx-auto md:mx-0 md:order-2 order-1">
